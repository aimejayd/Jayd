            ...
            <td><table border="0" cellpadding="0" cellspacing="0" align="center" width="98%">
                ...
                <tr>
                  <td height="18"><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
                      <tbody>
                        <tr valign="top">
                          <td colspan="2" class="headtext13" height="25" valign="middle"><strong><font face="euphemia">Reports</font></strong></td>
                        ...
                        <tr valign="top">
                          ...
                          <td class="smallpoints" valign="middle"><a href="waiting-list.php" class="link"><font face="euphemia">Waiting Report</font> </a></td>
                          <td colspan="3" rowspan="3"><img src="images/imagesform.jpg" width="103" height="95"><a href="#" class="link"></a></td>
                          </tr>
                        <tr valign="top">
                        ...
                        <tr valign="top">
                          ...
                          <td class="smallpoints" valign="middle"><a href="approved-list.php" class="link"><font face="euphemia">Approved Report</font> </a></td>
                          </tr>
                      </tbody>
                  </table></td>
                </tr>
