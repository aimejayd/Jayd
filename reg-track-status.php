 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tbody><tr>
                <td class="TrackTitle" valign="top"><div class="newtext" align="center"><strong><font face="euphemia"> Track Your Insurance Document</font><br>
                        </strong></div></td>
              </tr>
              <tr>
              ...
              <tr bgcolor="EFEFEF">
                <td class="aalpha" valign="top"><div align="center"><font face="euphemia">Enter the Consignment No </font></div></td>
              </tr>
              <tr bgcolor="EFEFEF">
                <td valign="top"><div align="center">
            <form action="ref-search.php" method="post" name="form" id="form" >
			      ...
			      <span class="gentxt"><font face="euphemia">Ex: IXM53533 </font></span> </div></td>
                </tr>
              <tr bgcolor="EFEFEF">
                <td valign="top">&nbsp;</td>
              </tr>
