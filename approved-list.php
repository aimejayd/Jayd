...
$sql = "SELECT cid, cons_no, clnt_name, off_name, iss_date, exp_date, time, amount, type, status
		FROM tbl_clients
...
<table border="0" align="center" width="80%">
    ...
    <tr>
      <td class="LargeBlue" bgcolor="#FFFFFF" align="left"><div class="Partext1" align="center"><strong><font face="euphemia">Update Insurance </font></strong></div></td>
    </tr>
  </tbody></table>
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
      ...
      <td class="newtext" bgcolor="#EDEDED" width="11%"><font face="euphemia">Officer</font></td>
      <td class="newtext" bgcolor="#EDEDED" width="18%"><font face="euphemia">Issued Date / Expired Time</font></td>
	...
	?>
      ...
      <td class="gentxt"><font face="euphemia"><?php echo $iss_date; ?></font> - <font face="euphemia"><?php echo $exp_date; ?></font></td>
