 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tr bgcolor="EFEFEF">
                <td valign="top"><strong><font face="euphemia">New Office is Added Successfully .</font></strong> <a href="offices-list.php"><font face="euphemia">Click Here</font></a> <font face="euphemia">To View all Office List</font> </td>
              </tr>
              <tr bgcolor="EFEFEF">
