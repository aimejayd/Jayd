            ...
            <form action="new_track_submit.php" method="post" name="form1" id="form1" onsubmit="return validate()"></form>
              <tbody><tr>
                <td colspan="2" class="TrackTitle" valign="top"><div class="newtext" align="center"><strong> <br>
                  <br>
                  <font face ="euphemia">SEARCH & EDIT CLIENT INSURANCE</font> <br>
                              </strong></div></td>
              </tr>
              <tr>
              ...
              <tr bgcolor="EFEFEF">
                <td colspan="2" class="aalpha" bgcolor="#FFFFFF" height="34" valign="top"><div class="gentxt" align="center"><font face="euphemia">Consignment Number is the Client Unique Number used to track the Client insurance document, modify the data etc... This is helpful for easy find your insurance documents</font><br>
                  <br>
                </div></td>
              </tr>
              <tr bgcolor="EFEFEF">
              ...
              <tr bgcolor="EFEFEF">
			  <form action="search-insurance.php" method="post">
                <td valign="top"><div align="right"><strong><font face="euphemia">Enter Consignment number</font></strong> </div></td>
