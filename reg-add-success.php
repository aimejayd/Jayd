 ...
 if (form.Consignment.value == "" )
		 {
			...
			return false;
              ...
              <tr bgcolor="EFEFEF">
                <td valign="top"><font face="euphemia"><font size="2.9"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client Information Added Successfully !!<font face="euphemia">&nbsp;Need to check your status &nbsp;</font></strong><a href="reg-track-status.php"><font face="euphemia"><font color="red">Click Here</font></font></font><br/>
				</td>
              </tr>
              <tr bgcolor="EFEFEF">
